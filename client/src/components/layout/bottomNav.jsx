...
const BottomNav = () => {
    ...
    return <div className="sticky bottom-0 z-50 w-full bg-dark bottom-nav">
        ...
        Partidas
            ...
            <button data-tooltip-target="tooltip-post" type="button" className="inline-flex flex-col items-center justify-center p-4 hover:bg-zinc-700 group" onClick={() => navigate("/create")}>
